...
df_original =pd.read_csv('/Users/matiasarbues/Desktop/ProyectoDeporte2/MedalTable (1).csv',sep=';')
...
def index():
    if request.method == 'POST':
        ...
        return redirect(url_for('resultado', pais=pais, medallas=medallas, confianza=confianza))
